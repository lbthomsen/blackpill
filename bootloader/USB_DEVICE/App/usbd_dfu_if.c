...
#define FLASH_DESC_STR      "@Internal Flash   /0x08000000/02*016Ka,03*032Kg,07*128Kg,04*016Kg,01*064Kg,07*128Kg,03*016Kg"
...
__ALIGN_BEGIN USBD_DFU_MediaTypeDef USBD_DFU_fops_FS __ALIGN_END = {
		...
		MEM_If_Erase_FS, MEM_If_Write_FS, MEM_If_Read_FS, MEM_If_GetStatus_FS };
