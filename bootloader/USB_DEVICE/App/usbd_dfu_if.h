...
/* USER CODE BEGIN EXPORTED_DEFINES */
 // /0x08000000/02*16Ka,02*16Kg,01*64Kg,03*128Kg
 ...
 #define ADDR_FLASH_SECTOR_6     ((uint32_t)0x08040000) /* Base @ of Sector 5, 128 Kbytes */
 #define ADDR_FLASH_SECTOR_7     ((uint32_t)0x08060000) /* Base @ of Sector 5, 128 Kbytes */
