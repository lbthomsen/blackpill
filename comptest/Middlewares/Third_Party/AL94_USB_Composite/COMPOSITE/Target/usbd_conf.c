...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  if (pdev->id == DEVICE_HS)
  {
    ...
    HAL_PCDEx_SetRxFiFo(hpcd_USB_OTG_PTR, 1024);

    HAL_PCDEx_SetTxFiFo(hpcd_USB_OTG_PTR, 0, 64); // EP0 IN
    ...
    HAL_PCDEx_SetTxFiFo(hpcd_USB_OTG_PTR, (CDC_RNDIS_IN_EP & 0x7F), 512);
    HAL_PCDEx_SetTxFiFo(hpcd_USB_OTG_PTR, (CDC_RNDIS_CMD_EP & 0x7F), 64);
#endif
#if (USBD_USE_CDC_ECM == 1)
    HAL_PCDEx_SetTxFiFo(hpcd_USB_OTG_PTR, (CDC_ECM_IN_EP & 0x7F), 512);
    HAL_PCDEx_SetTxFiFo(hpcd_USB_OTG_PTR, (CDC_ECM_CMD_EP & 0x7F), 64);
#endif
#if (USBD_USE_HID_MOUSE == 1)
    HAL_PCDEx_SetTxFiFo(hpcd_USB_OTG_PTR, (HID_MOUSE_IN_EP & 0x7F), 128);
#endif
...
#endif
#if (USBD_USE_PRNTR == 1)
    HAL_PCDEx_SetTxFiFo(hpcd_USB_OTG_PTR, (PRNT_IN_EP & 0x7F), 512);
#endif
  }
#else
  /**FULL SPEED USB */
