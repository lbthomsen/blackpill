...
usbhid/%.o usbhid/%.su: ../usbhid/%.c usbhid/subdir.mk
...
clean-usbhid:
	-$(RM) ./usbhid/usb_device.d ./usbhid/usb_device.o ./usbhid/usb_device.su ./usbhid/usbd_conf.d ./usbhid/usbd_conf.o ./usbhid/usbd_conf.su ./usbhid/usbd_core.d ./usbhid/usbd_core.o ./usbhid/usbd_core.su ./usbhid/usbd_ctlreq.d ./usbhid/usbd_ctlreq.o ./usbhid/usbd_ctlreq.su ./usbhid/usbd_custom_hid_if.d ./usbhid/usbd_custom_hid_if.o ./usbhid/usbd_custom_hid_if.su ./usbhid/usbd_customhid.d ./usbhid/usbd_customhid.o ./usbhid/usbd_customhid.su ./usbhid/usbd_desc.d ./usbhid/usbd_desc.o ./usbhid/usbd_desc.su ./usbhid/usbd_ioreq.d ./usbhid/usbd_ioreq.o ./usbhid/usbd_ioreq.su
